 ...
 */
package com.jdbc.sql.dialect.oracle.visitor;

import java.util.List;

import com.jdbc.sql.ast.SQLArgument;
import com.jdbc.sql.ast.SQLDataType;
import com.jdbc.sql.ast.SQLExpr;
import com.jdbc.sql.ast.SQLHint;
...
import com.jdbc.sql.ast.statement.SQLCheck;
...
import com.jdbc.sql.ast.statement.SQLJoinTableSource.JoinType;
import com.jdbc.sql.ast.statement.SQLRollbackStatement;
import com.jdbc.sql.ast.statement.SQLSavePointStatement;
import com.jdbc.sql.ast.statement.SQLScriptCommitStatement;
...
import com.jdbc.sql.ast.statement.SQLTruncateStatement;
import com.jdbc.sql.ast.statement.SQLUnique;
import com.jdbc.sql.ast.statement.SQLWithSubqueryClause;
import com.jdbc.sql.dialect.oracle.ast.OracleDataTypeIntervalDay;
import com.jdbc.sql.dialect.oracle.ast.OracleDataTypeIntervalYear;
import com.jdbc.sql.dialect.oracle.ast.clause.CycleClause;
import com.jdbc.sql.dialect.oracle.ast.clause.ModelClause;
import com.jdbc.sql.dialect.oracle.ast.clause.ModelClause.CellAssignment;
import com.jdbc.sql.dialect.oracle.ast.clause.ModelClause.CellAssignmentItem;
import com.jdbc.sql.dialect.oracle.ast.clause.ModelClause.CellReferenceOption;
import com.jdbc.sql.dialect.oracle.ast.clause.ModelClause.MainModelClause;
import com.jdbc.sql.dialect.oracle.ast.clause.ModelClause.ModelColumn;
import com.jdbc.sql.dialect.oracle.ast.clause.ModelClause.ModelColumnClause;
import com.jdbc.sql.dialect.oracle.ast.clause.ModelClause.ModelRuleOption;
import com.jdbc.sql.dialect.oracle.ast.clause.ModelClause.ModelRulesClause;
import com.jdbc.sql.dialect.oracle.ast.clause.ModelClause.QueryPartitionClause;
import com.jdbc.sql.dialect.oracle.ast.clause.ModelClause.ReferenceModelClause;
import com.jdbc.sql.dialect.oracle.ast.clause.ModelClause.ReturnRowsClause;
import com.jdbc.sql.dialect.oracle.ast.clause.OracleLobStorageClause;
import com.jdbc.sql.dialect.oracle.ast.clause.OracleReturningClause;
import com.jdbc.sql.dialect.oracle.ast.clause.OracleStorageClause;
import com.jdbc.sql.dialect.oracle.ast.clause.OracleWithSubqueryEntry;
import com.jdbc.sql.dialect.oracle.ast.clause.PartitionExtensionClause;
import com.jdbc.sql.dialect.oracle.ast.clause.SampleClause;
import com.jdbc.sql.dialect.oracle.ast.clause.SearchClause;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleAnalytic;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleAnalyticWindowing;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleArgumentExpr;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleBinaryDoubleExpr;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleBinaryFloatExpr;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleCursorExpr;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleDatetimeExpr;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleDbLinkExpr;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleIntervalExpr;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleIsOfTypeExpr;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleIsSetExpr;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleOuterExpr;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleRangeExpr;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleSizeExpr;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleSysdateExpr;
import com.jdbc.sql.dialect.oracle.ast.expr.OracleTreatExpr;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement.Rebuild;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterSessionStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterSynonymStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterTableDropPartition;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterTableModify;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterTableMoveTablespace;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.NestedTablePartitionSpec;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.TableSpaceItem;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.UpdateIndexesClause;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterTableTruncatePartition;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceAddDataFile;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterTriggerStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleAlterViewStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleCheck;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleConstraint;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleContinueStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleCreateDatabaseDbLinkStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleCreateIndexStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleCreatePackageStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleCreateSynonymStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleCreateTableStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleCreateTypeStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleDeleteStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleDropDbLinkStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleExceptionStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleExecuteImmediateStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleExitStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleExplainStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleFileSpecification;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleForStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleForeignKey;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleGotoStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleInsertStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleLabelStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleLockTableStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClause;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClauseItem;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.InsertIntoClause;
import com.jdbc.sql.dialect.oracle.ast.stmt.OraclePipeRowStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OraclePrimaryKey;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleRaiseStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleRunStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleSelectJoin;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleSelectPivot;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleSelectPivot.Item;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleSelectPivotBase;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleSelectQueryBlock;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleSelectRestriction;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.CheckOption;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.ReadOnly;
...
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleSelectUnPivot;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleSetTransactionStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleSupplementalIdKey;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleSupplementalLogGrp;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleUnique;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleUpdateStatement;
import com.jdbc.sql.dialect.oracle.ast.stmt.OracleUsingIndexClause;
import com.jdbc.sql.dialect.oracle.parser.OracleFunctionDataType;
import com.jdbc.sql.dialect.oracle.parser.OracleProcedureDataType;
...
//    }
    ...
    @Override
    public void endVisit(com.jdbc.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {

    }

    @Override
    public boolean visit(com.jdbc.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {
        print0(ucase ? "WHEN " : "when ");
        x.getWhen().accept(this);
        print0(ucase ? " THEN" : " then");
