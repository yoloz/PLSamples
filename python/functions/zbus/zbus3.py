# encoding=utf8
"""
modify by gjw on 20170405
1support the python3
2add the removeMQ and queryMQ
...
class Proto:
    ...
    CreateMQ = "create_mq"  # 创建队列
    RemoveMQ = "remove_mq"  # 删除队列
    QueryMQ = "query_mq"  # 查询队列
...
class MessageClient(object):
    ...
    def send(self, msg, timeout=10):
        ...
        self.sock.sendall(bytes(msg.__str__(), 'utf8'))
    ...
    def recv(self, timeout=10):
        ...
        while True:
            ...
            print("aaaaaaa:", buf.decode("utf8"))
            # self.read_buf += buf
            self.read_buf += buf.decode("utf8")
            idx = 0
            while True:
...
class Rpc(Caller):
    ...
    def _error_msg(self, msg_req):
        ...
        self.mq, self.module, self.method, msg_req)
